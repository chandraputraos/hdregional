...
class dataRoot
{
    ...
    public function getSession()
    {
        ...
        if (isset($_SESSION['user_id'])) {
            ...
            $session_data["user_email"] = $_SESSION['user_email'];
			 $session_data["user_team"] = $_SESSION['user_team'];
			 $session_data["user_namalengkap"] = $_SESSION['user_namalengkap'];
			  $session_data["user_role"] = $_SESSION['user_role'];
			...
			$session_data["user_team"] = '';
			$session_data["user_namalengkap"] = 'Halu :))';
			$session_data["user_role"] = 'Halu :))';
    ...
    public function destroySession()
    {
        ...
        if (isSet($_SESSION['user_id'])) {
			...
			unset($_SESSION['user_namalengkap']);
